...
namespace Bolletta_Luce_versione_Menù
{
    ...
    */
        ...
        private static void Stampa(string name, string surname, double kilowatt)
        {
            Console.WriteLine($"Ciao {name}  {surname}, il calcolo del costo della tua bolletta risulta: {kilowatt}");
        }
    }
}
